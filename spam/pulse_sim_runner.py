...
element_frequencies = [wa]
drive_frequencies = [wa]
drive_element_indices = [0]
reward_function = qubit_excited
verbose = True
...
for A in test_amps:
    ...
    qubit_drive_amplitude = A
    qubit_drive_mu = 0.05 * us
    qubit_drive_sigma = 0.02 * us

    drive_funcs = [gauss(qubit_drive_amplitude, qubit_drive_mu, qubit_drive_sigma, 0), zero] # This array requires 2 functions for each drive, one real, and one imaginary
