...
root_dir = r'C:\Users\Wang_Lab\Documents\GitLab\quantum_control_rl_server\examples\exp_e_EXAMPLE\save_data' # root_dir = os.getcwd() #r'E:\rl_data\exp_training\pi_pulse'
