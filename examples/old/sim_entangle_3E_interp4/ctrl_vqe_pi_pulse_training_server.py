...
with open(sf_name, "rb") as fp:
    epochs, train_batch_size, init_amps, init_times, amp_scales, time_scales, hdf5_name = pickle.load(fp)
fp.close()
epochs = int(epochs)
...
# print(f'server casted args: {epochs, train_batch_size, init_amps, amp_scales, hdf5_name}')

root_dir = r'/examples/old/sim_entangle_3E_interp4/save_data'  # root_dir = os.getcwd() #r'E:\rl_data\exp_training\pi_pulse'
